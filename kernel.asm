...
bget(uint dev, uint blockno)
{
	...
	acquire(&bcache.lock);
801000e6:	e8 35 41 00 00       	call   80104220 <acquire>
...
80100209:	e8 12 40 00 00       	call   80104220 <acquire>
	b->refcnt--;
	if (b->refcnt == 0) {
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
	cprintf("\n");
80100399:	c7 04 24 7b 76 10 80 	movl   $0x8010767b,(%esp)
...
80100d83:	e8 98 34 00 00       	call   80104220 <acquire>
...
80100df1:	e8 2a 34 00 00       	call   80104220 <acquire>
...
80100e43:	e8 d8 33 00 00       	call   80104220 <acquire>
...
801011a5:	c7 04 24 bf 6d 10 80 	movl   $0x80106dbf,(%esp)
...
801011f8:	e8 63 31 00 00       	call   80104360 <memset>
	log_write(bp);
...
80101239:	89 55 e4             	mov    %edx,-0x1c(%ebp)
	...
	acquire(&icache.lock);
8010123c:	e8 df 2f 00 00       	call   80104220 <acquire>
...
80101276:	89 4b 08             	mov    %ecx,0x8(%ebx)
			release(&icache.lock);
80101279:	e8 92 30 00 00       	call   80104310 <release>
	ip->ref   = 1;
	ip->valid = 0;
	release(&icache.lock);
...
801012be:	e8 4d 30 00 00       	call   80104310 <release>
...
801012cc:	c3                   	ret    
	...
	// Recycle an inode cache entry.
	if (empty == 0) panic("iget: no inodes");
801012cd:	c7 04 24 d5 6d 10 80 	movl   $0x80106dd5,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
	...
	panic("bmap: out of range");
80101387:	c7 04 24 e5 6d 10 80 	movl   $0x80106de5,(%esp)
...
801013d2:	e8 29 30 00 00       	call   80104400 <memmove>
	brelse(bp);
...
80101468:	c3                   	ret    
	...
	m  = 1 << (bi % 8);
	if ((bp->data[bi / 8] & m) == 0) panic("freeing free block");
80101469:	c7 04 24 f8 6d 10 80 	movl   $0x80106df8,(%esp)
...
8010148c:	c7 44 24 04 0b 6e 10 	movl   $0x80106e0b,0x4(%esp)
80101493:	80 
80101494:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010149b:	e8 90 2c 00 00       	call   80104130 <initlock>
	for (i = 0; i < NINODE; i++) {
		initsleeplock(&icache.inode[i].lock, "inode");
801014a0:	89 1c 24             	mov    %ebx,(%esp)
801014a3:	81 c3 90 00 00 00    	add    $0x90,%ebx
801014a9:	c7 44 24 04 12 6e 10 	movl   $0x80106e12,0x4(%esp)
801014b0:	80 
801014b1:	e8 6a 2b 00 00       	call   80104020 <initsleeplock>
iinit(int dev)
{
	int i = 0;
...
801014d6:	c7 04 24 78 6e 10 80 	movl   $0x80106e78,(%esp)
...
801015b9:	e8 a2 2d 00 00       	call   80104360 <memset>
			dip->type = type;
...
801015ec:	e9 2f fc ff ff       	jmp    80101220 <iget>
	...
	panic("ialloc: no inodes");
801015f1:	c7 04 24 18 6e 10 80 	movl   $0x80106e18,(%esp)
...
8010166f:	00 
80101670:	e8 8b 2d 00 00       	call   80104400 <memmove>
	log_write(bp);
...
801016a1:	e8 7a 2b 00 00       	call   80104220 <acquire>
	ip->ref++;
801016a6:	83 43 08 01          	addl   $0x1,0x8(%ebx)
	release(&icache.lock);
801016aa:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016b1:	e8 5a 2c 00 00       	call   80104310 <release>
	return ip;
}
...
801016e4:	e8 77 29 00 00       	call   80104060 <acquiresleep>
...
8010175b:	e8 a0 2c 00 00       	call   80104400 <memmove>
		brelse(bp);
...
8010177a:	c7 04 24 30 6e 10 80 	movl   $0x80106e30,(%esp)
...
ilock(struct inode *ip)
{
	...
	if (ip == 0 || ip->ref < 1) panic("ilock");
80101786:	c7 04 24 2a 6e 10 80 	movl   $0x80106e2a,(%esp)
...
801017b5:	e8 46 29 00 00       	call   80104100 <holdingsleep>
...
iunlock(struct inode *ip)
{
	...
	releasesleep(&ip->lock);
801017ce:	e9 ed 28 00 00       	jmp    801040c0 <releasesleep>
...
{
	if (ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1) panic("iunlock");
801017d3:	c7 04 24 3f 6e 10 80 	movl   $0x80106e3f,(%esp)
...
801017f2:	e8 69 28 00 00       	call   80104060 <acquiresleep>
...
80101808:	e8 b3 28 00 00       	call   801040c0 <releasesleep>

	acquire(&icache.lock);
8010180d:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101814:	e8 07 2a 00 00       	call   80104220 <acquire>
	ip->ref--;
...
8010182a:	5d                   	pop    %ebp
	...
	ip->ref--;
	release(&icache.lock);
8010182b:	e9 e0 2a 00 00       	jmp    80104310 <release>
void
iput(struct inode *ip)
{
	acquiresleep(&ip->lock);
...
80101837:	e8 e4 29 00 00       	call   80104220 <acquire>
		int r = ip->ref;
8010183c:	8b 5e 08             	mov    0x8(%esi),%ebx
		release(&icache.lock);
8010183f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101846:	e8 c5 2a 00 00       	call   80104310 <release>
		if (r == 1) {
...
80101a18:	e8 e3 29 00 00       	call   80104400 <memmove>
		brelse(bp);
...
80101b14:	e8 e7 28 00 00       	call   80104400 <memmove>
		log_write(bp);
...
80101bbb:	e8 c0 28 00 00       	call   80104480 <strncmp>
}
80101bc0:	c9                   	leave  
80101bc1:	c3                   	ret    
...
80101c39:	e8 42 28 00 00       	call   80104480 <strncmp>
	if (dp->type != T_DIR) panic("dirlookup not DIR");
...
80101c71:	c3                   	ret    
	...
	for (off = 0; off < dp->size; off += sizeof(de)) {
		if (readi(dp, (char *)&de, off, sizeof(de)) != sizeof(de)) panic("dirlookup read");
80101c72:	c7 04 24 59 6e 10 80 	movl   $0x80106e59,(%esp)
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
	...
	if (dp->type != T_DIR) panic("dirlookup not DIR");
80101c7e:	c7 04 24 47 6e 10 80 	movl   $0x80106e47,(%esp)
...
80101cb8:	e8 63 25 00 00       	call   80104220 <acquire>
	ip->ref++;
80101cbd:	83 46 08 01          	addl   $0x1,0x8(%esi)
	release(&icache.lock);
80101cc1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cc8:	e8 43 26 00 00       	call   80104310 <release>
...
80101d2b:	e8 d0 26 00 00       	call   80104400 <memmove>
	int   len;
...
80101db9:	e8 42 26 00 00       	call   80104400 <memmove>
		name[len] = 0;
...
80101eb3:	e8 38 26 00 00       	call   801044f0 <strncpy>
	de.inum = inum;
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
	...
	for (off = 0; off < dp->size; off += sizeof(de)) {
		if (readi(dp, (char *)&de, off, sizeof(de)) != sizeof(de)) panic("dirlink read");
80101ef5:	c7 04 24 68 6e 10 80 	movl   $0x80106e68,(%esp)
...
idestart(struct buf *b)
{
	if (b == 0) panic("idestart");
	if (b->blockno >= FSSIZE) panic("incorrect blockno");
80101fef:	c7 04 24 d4 6e 10 80 	movl   $0x80106ed4,(%esp)
...
{
	if (b == 0) panic("idestart");
80101ffb:	c7 04 24 cb 6e 10 80 	movl   $0x80106ecb,(%esp)
...
80102016:	c7 44 24 04 e6 6e 10 	movl   $0x80106ee6,0x4(%esp)
8010201d:	80 
8010201e:	c7 04 24 80 a5 10 80 	movl   $0x8010a580,(%esp)
80102025:	e8 06 21 00 00       	call   80104130 <initlock>
...
801020a0:	e8 7b 21 00 00       	call   80104220 <acquire>
...
801020e6:	e8 25 22 00 00       	call   80104310 <release>
...
80102140:	e8 bb 1f 00 00       	call   80104100 <holdingsleep>
...
80102176:	e8 a5 20 00 00       	call   80104220 <acquire>
...
801021d5:	5d                   	pop    %ebp
	...
	release(&idelock);
801021d6:	e9 35 21 00 00       	jmp    80104310 <release>
...
iderw(struct buf *b)
{
	...
	if (!holdingsleep(&b->lock)) panic("iderw: buf not locked");
801021eb:	c7 04 24 ea 6e 10 80 	movl   $0x80106eea,(%esp)
801021f2:	e8 69 e1 ff ff       	call   80100360 <panic>
	if ((b->flags & (B_VALID | B_DIRTY)) == B_VALID) panic("iderw: nothing to do");
	if (b->dev != 0 && !havedisk1) panic("iderw: ide disk 1 not present");
801021f7:	c7 04 24 15 6f 10 80 	movl   $0x80106f15,(%esp)
...
iderw(struct buf *b)
{
	...
	if (!holdingsleep(&b->lock)) panic("iderw: buf not locked");
	if ((b->flags & (B_VALID | B_DIRTY)) == B_VALID) panic("iderw: nothing to do");
80102203:	c7 04 24 00 6f 10 80 	movl   $0x80106f00,(%esp)
...
80102258:	c7 04 24 34 6f 10 80 	movl   $0x80106f34,(%esp)
...
8010233a:	e8 21 20 00 00       	call   80104360 <memset>
...
80102373:	5d                   	pop    %ebp
	...
	kmem.freelist = r;
	if (kmem.use_lock) release(&kmem.lock);
80102374:	e9 97 1f 00 00       	jmp    80104310 <release>
...
80102387:	e8 94 1e 00 00       	call   80104220 <acquire>
...
kfree(char *v)
{
	...
	if ((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP) panic("kfree");
8010238e:	c7 04 24 66 6f 10 80 	movl   $0x80106f66,(%esp)
...
801023fb:	c7 44 24 04 6c 6f 10 	movl   $0x80106f6c,0x4(%esp)
80102402:	80 
80102403:	c7 04 24 40 26 11 80 	movl   $0x80112640,(%esp)
8010240a:	e8 21 1d 00 00       	call   80104130 <initlock>
...
801024dd:	e8 2e 1e 00 00       	call   80104310 <release>
	return (char *)r;
}
...
801024f7:	e8 24 1d 00 00       	call   80104220 <acquire>
...
80102544:	0f b6 81 a0 70 10 80 	movzbl -0x7fef8f60(%ecx),%eax
...
80102578:	0f b6 91 a0 70 10 80 	movzbl -0x7fef8f60(%ecx),%edx
	shift ^= togglecode[data];
8010257f:	0f b6 81 a0 6f 10 80 	movzbl -0x7fef9060(%ecx),%eax
		// Last character was an E0 escape; or with 0x80
		data |= 0x80;
		shift &= ~E0ESC;
	}
...
8010258f:	8b 04 85 80 6f 10 80 	mov    -0x7fef9080(,%eax,4),%eax
		data |= 0x80;
		shift &= ~E0ESC;
	}
...
801028ac:	e8 ff 1a 00 00       	call   801043b0 <memcmp>
...
801029d7:	e8 24 1a 00 00       	call   80104400 <memmove>
...
80102a8b:	c7 44 24 04 a0 71 10 	movl   $0x801071a0,0x4(%esp)
80102a92:	80 
80102a93:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102a9a:	e8 91 16 00 00       	call   80104130 <initlock>
	readsb(dev, &sb);
...
80102b2d:	e8 ee 16 00 00       	call   80104220 <acquire>
...
80102b75:	a3 bc 26 11 80       	mov    %eax,0x801126bc
			release(&log.lock);
80102b7a:	e8 91 17 00 00       	call   80104310 <release>
			break;
		}
	}
}
...
80102ba0:	e8 7b 16 00 00       	call   80104220 <acquire>
	log.outstanding -= 1;
...
80102bd8:	00 00 00 
	...
	release(&log.lock);
80102bdb:	e8 30 17 00 00       	call   80104310 <release>
}
...
80102c3f:	e8 bc 17 00 00       	call   80104400 <memmove>
...
80102c84:	e8 97 15 00 00       	call   80104220 <acquire>
		log.committing = 0;
...
80102ca6:	e8 65 16 00 00       	call   80104310 <release>
	}
}
...
80102cb2:	c3                   	ret    
{
	...
	log.outstanding -= 1;
	if (log.committing) panic("log.committing");
80102cb3:	c7 04 24 a4 71 10 80 	movl   $0x801071a4,(%esp)
...
80102cfd:	e8 1e 15 00 00       	call   80104220 <acquire>
	for (i = 0; i < log.lh.n; i++) {
...
80102d4e:	5d                   	pop    %ebp
	...
	b->flags |= B_DIRTY; // prevent eviction
	release(&log.lock);
80102d4f:	e9 bc 15 00 00       	jmp    80104310 <release>
...
log_write(struct buf *b)
{
	...
	if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1) panic("too big a transaction");
80102d70:	c7 04 24 b3 71 10 80 	movl   $0x801071b3,(%esp)
80102d77:	e8 e4 d5 ff ff       	call   80100360 <panic>
	if (log.outstanding < 1) panic("log_write outside of trans");
80102d7c:	c7 04 24 c9 71 10 80 	movl   $0x801071c9,(%esp)
...
80102da7:	c7 04 24 e4 71 10 80 	movl   $0x801071e4,(%esp)
80102dae:	89 44 24 04          	mov    %eax,0x4(%esp)
80102db2:	e8 99 d8 ff ff       	call   80100650 <cprintf>
	idtinit();                    // load idt register
80102db7:	e8 e4 27 00 00       	call   801055a0 <idtinit>
...
80102de3:	83 ec 08             	sub    $0x8,%esp
	switchkvm();
80102de6:	e8 75 38 00 00       	call   80106660 <switchkvm>
	seginit();
80102deb:	e8 b0 37 00 00       	call   801065a0 <seginit>
	lapicinit();
...
80102e35:	e8 66 37 00 00       	call   801065a0 <seginit>
	picinit();                                  // disable pic
...
80102e4a:	e8 71 2a 00 00       	call   801058c0 <uartinit>
80102e4f:	90                   	nop
	pinit();                                    // process table
80102e50:	e8 9b 07 00 00       	call   801035f0 <pinit>
	tvinit();                                   // trap vectors
80102e55:	e8 a6 26 00 00       	call   80105500 <tvinit>
	binit();                                    // buffer cache
...
80102e81:	e8 7a 15 00 00       	call   80104400 <memmove>
...
80102f4f:	00 
80102f50:	c7 44 24 04 f8 71 10 	movl   $0x801071f8,0x4(%esp)
80102f57:	80 
80102f58:	89 34 24             	mov    %esi,(%esp)
80102f5b:	e8 50 14 00 00       	call   801043b0 <memcmp>
...
8010300a:	00 
8010300b:	c7 44 24 04 fd 71 10 	movl   $0x801071fd,0x4(%esp)
80103012:	80 
...
80103016:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	if (memcmp(conf, "PCMP", 4) != 0) return 0;
80103019:	e8 92 13 00 00       	call   801043b0 <memcmp>
...
8010309c:	ff 24 8d 3c 72 10 80 	jmp    *-0x7fef8dc4(,%ecx,4)
801030a3:	90                   	nop
...
80103127:	0f 85 c5 fe ff ff    	jne    80102ff2 <mpinit+0x52>
	...
	if ((conf = mpconfig(&mp)) == 0) panic("Expect to run on an SMP");
8010312d:	c7 04 24 02 72 10 80 	movl   $0x80107202,(%esp)
...
80103148:	eb e3                	jmp    8010312d <mpinit+0x18d>
	...
	if (!ismp) panic("Didn't find a suitable machine");
8010314a:	c7 04 24 1c 72 10 80 	movl   $0x8010721c,(%esp)
...
801031ef:	c7 44 24 04 50 72 10 	movl   $0x80107250,0x4(%esp)
801031f6:	80 
801031f7:	e8 34 0f 00 00       	call   80104130 <initlock>
	(*f0)->type     = FD_PIPE;
...
80103281:	e8 9a 0f 00 00       	call   80104220 <acquire>
	if (writable) {
...
801032be:	5d                   	pop    %ebp
	...
	if (p->readopen == 0 && p->writeopen == 0) {
		...
		release(&p->lock);
801032bf:	e9 4c 10 00 00       	jmp    80104310 <release>
...
801032eb:	e8 20 10 00 00       	call   80104310 <release>
		kfree((char *)p);
...
8010330f:	e8 0c 0f 00 00       	call   80104220 <acquire>
	for (i = 0; i < n; i++) {
...
80103392:	e8 79 0f 00 00       	call   80104310 <release>
				return -1;
...
801033e2:	e8 29 0f 00 00       	call   80104310 <release>
	return n;
...
80103402:	e8 19 0e 00 00       	call   80104220 <acquire>
...
8010345b:	e8 b0 0e 00 00       	call   80104310 <release>
...
801034bd:	e8 4e 0e 00 00       	call   80104310 <release>
	return i;
}
...
801034e3:	e8 38 0d 00 00       	call   80104220 <acquire>
...
8010351e:	89 43 10             	mov    %eax,0x10(%ebx)
	...
	release(&ptable.lock);
80103521:	e8 ea 0d 00 00       	call   80104310 <release>
...
8010353d:	89 53 18             	mov    %edx,0x18(%ebx)
	...
	sp -= 4;
	*(uint *)sp = (uint)trapret;
80103540:	c7 40 14 f5 54 10 80 	movl   $0x801054f5,0x14(%eax)
...
8010355a:	89 43 1c             	mov    %eax,0x1c(%ebx)
	memset(p->context, 0, sizeof *p->context);
8010355d:	e8 fe 0d 00 00       	call   80104360 <memset>
...
8010357f:	e8 8c 0d 00 00       	call   80104310 <release>
	p->context = (struct context *)sp;
	memset(p->context, 0, sizeof *p->context);
	p->context->eip = (uint)forkret;
...
801035ad:	e8 5e 0d 00 00       	call   80104310 <release>
...
801035f6:	c7 44 24 04 55 72 10 	movl   $0x80107255,0x4(%esp)
801035fd:	80 
801035fe:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103605:	e8 26 0b 00 00       	call   80104130 <initlock>
}
8010360a:	c9                   	leave  
8010360b:	c3                   	ret    
...
80103668:	eb ea                	jmp    80103654 <mycpu+0x44>
	...
	panic("unknown apicid\n");
8010366a:	c7 04 24 5c 72 10 80 	movl   $0x8010725c,(%esp)
...
mycpu(void)
{
	...
	if (readeflags() & FL_IF) panic("mycpu called with interrupts enabled\n");
80103676:	c7 04 24 38 73 10 80 	movl   $0x80107338,(%esp)
...
801036b4:	83 ec 04             	sub    $0x4,%esp
	...
	struct proc *p;
	pushcli();
801036b7:	e8 24 0b 00 00       	call   801041e0 <pushcli>
	c = mycpu();
801036bc:	e8 4f ff ff ff       	call   80103610 <mycpu>
	p = c->proc;
801036c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
	popcli();
801036c7:	e8 d4 0b 00 00       	call   801042a0 <popcli>
	return p;
}
...
80103715:	80 
80103716:	e8 75 30 00 00       	call   80106790 <inituvm>
	p->sz = PGSIZE;
...
80103737:	e8 24 0c 00 00       	call   80104360 <memset>
...
80103792:	00 
80103793:	c7 44 24 04 85 72 10 	movl   $0x80107285,0x4(%esp)
8010379a:	80 
8010379b:	89 04 24             	mov    %eax,(%esp)
8010379e:	e8 9d 0d 00 00       	call   80104540 <safestrcpy>
	p->cwd = namei("/");
801037a3:	c7 04 24 8e 72 10 80 	movl   $0x8010728e,(%esp)
...
801037b9:	e8 62 0a 00 00       	call   80104220 <acquire>
...
801037cc:	e8 3f 0b 00 00       	call   80104310 <release>
}
...
801037d6:	c3                   	ret    
	...
	initproc = p;
	if ((p->pgdir = setupkvm()) == 0) panic("userinit: out of memory?");
801037d7:	c7 04 24 6c 72 10 80 	movl   $0x8010726c,(%esp)
...
80103819:	e8 b2 30 00 00       	call   801068d0 <allocuvm>
...
80103827:	e8 54 2e 00 00       	call   80106680 <switchuvm>
	return 0;
...
8010388e:	e8 ad 32 00 00       	call   80106b40 <copyuvm>
...
8010390d:	e8 2e 0c 00 00       	call   80104540 <safestrcpy>
...
8010391c:	e8 ff 08 00 00       	call   80104220 <acquire>
...
8010392f:	e8 dc 09 00 00       	call   80104310 <release>
...
80103998:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
	for (;;) {
		...
		// Loop over process table looking for process to run.
		acquire(&ptable.lock);
8010399d:	e8 7e 08 00 00       	call   80104220 <acquire>
...
801039c2:	83 c3 7c             	add    $0x7c,%ebx
			...
			c->proc = p;
			switchuvm(p);
801039c5:	e8 b6 2c 00 00       	call   80106680 <switchuvm>
			p->state = RUNNING;
...
801039db:	e8 bb 0b 00 00       	call   8010459b <swtch>
			switchkvm();
801039e0:	e8 7b 2c 00 00       	call   80106660 <switchkvm>
		// Enable interrupts on this processor.
		sti();
...
801039ff:	e8 0c 09 00 00       	call   80104310 <release>
	}
...
80103a67:	e8 2f 0b 00 00       	call   8010459b <swtch>
	mycpu()->intena = intena;
...
80103b13:	e8 08 07 00 00       	call   80104220 <acquire>
...
80103ba6:	e8 65 fe ff ff       	call   80103a10 <sched>
	panic("zombie exit");
80103bab:	c7 04 24 dd 72 10 80 	movl   $0x801072dd,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
{
	...
	if (curproc == initproc) panic("init exiting");
80103bb7:	c7 04 24 d0 72 10 80 	movl   $0x801072d0,(%esp)
...
80103bdd:	e8 3e 06 00 00       	call   80104220 <acquire>
...
80103bfa:	e8 11 07 00 00       	call   80104310 <release>
}
80103bff:	c9                   	leave  
80103c00:	c3                   	ret    
...
80103c41:	e8 da 05 00 00       	call   80104220 <acquire>
		release(lk);
80103c46:	89 34 24             	mov    %esi,(%esp)
80103c49:	e8 c2 06 00 00       	call   80104310 <release>
	}
	// Go to sleep.
	p->chan  = chan;
...
80103c6b:	e8 a0 06 00 00       	call   80104310 <release>
		acquire(lk);
...
80103c79:	5d                   	pop    %ebp
	...
	if (lk != &ptable.lock) { // DOC: sleeplock2
		release(&ptable.lock);
		acquire(lk);
80103c7a:	e9 a1 05 00 00       	jmp    80104220 <acquire>
80103c7f:	90                   	nop
	if (lk != &ptable.lock) {      // DOC: sleeplock0
		acquire(&ptable.lock); // DOC: sleeplock1
		release(lk);
...
80103c9d:	c3                   	ret    
{
	...
	if (lk == 0) panic("sleep without lk");
80103c9e:	c7 04 24 ef 72 10 80 	movl   $0x801072ef,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
	...
	if (p == 0) panic("sleep");
80103caa:	c7 04 24 e9 72 10 80 	movl   $0x801072e9,(%esp)
...
80103cd4:	89 c6                	mov    %eax,%esi
	...
	acquire(&ptable.lock);
80103cd6:	e8 45 05 00 00       	call   80104220 <acquire>
	for (;;) {
...
80103d6d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
				release(&ptable.lock);
80103d74:	e8 97 05 00 00       	call   80104310 <release>
		}
...
80103d89:	e8 82 05 00 00       	call   80104310 <release>
		}
...
80103db1:	e8 6a 04 00 00       	call   80104220 <acquire>
static void
wakeup1(void *chan)
{
	struct proc *p;
...
wakeup(void *chan)
{
	...
	wakeup1(chan);
	release(&ptable.lock);
80103df4:	e9 17 05 00 00       	jmp    80104310 <release>
...
80103e11:	e8 0a 04 00 00       	call   80104220 <acquire>
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
...
80103e43:	e8 c8 04 00 00       	call   80104310 <release>
			return 0;
		}
	}
	release(&ptable.lock);
...
80103e67:	e8 a4 04 00 00       	call   80104310 <release>
	return -1;
}
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		...
		cprintf("\n");
80103e98:	c7 04 24 7b 76 10 80 	movl   $0x8010767b,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
			...
			state = "???";
80103ebd:	ba 00 73 10 80       	mov    $0x80107300,%edx
	char *       state;
	uint         pc[10];
...
80103ec4:	8b 14 85 60 73 10 80 	mov    -0x7fef8ca0(,%eax,4),%edx
			state = states[p->state];
		else
			state = "???";
80103ecb:	b8 00 73 10 80       	mov    $0x80107300,%eax
...
80103ee0:	c7 04 24 04 73 10 80 	movl   $0x80107304,(%esp)
...
80103f0c:	e8 3f 02 00 00       	call   80104150 <getcallerpcs>
...
80103f29:	c7 04 24 41 6d 10 80 	movl   $0x80106d41,(%esp)
...
//edit copy procdump
int
procstat0(int which, struct pstat*pst){
80103f50:	55                   	push   %ebp
	int pNum = 0;
	struct proc *p;

	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103f51:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
	}
}
...
80103f5b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103f5e:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80103f61:	eb 14                	jmp    80103f77 <procstat0+0x27>
80103f63:	90                   	nop
...
80103f6b:	81 fa 54 4c 11 80    	cmp    $0x80114c54,%edx
80103f71:	0f 84 9a 00 00 00    	je     80104011 <procstat0+0xc1>
		if (p->state == UNUSED) continue;
80103f77:	83 7a 0c 00          	cmpl   $0x0,0xc(%edx)
80103f7b:	74 eb                	je     80103f68 <procstat0+0x18>
		pNum++;
80103f7d:	83 c0 01             	add    $0x1,%eax
		if (pNum!=which) continue;
80103f80:	39 c8                	cmp    %ecx,%eax
80103f82:	75 e4                	jne    80103f68 <procstat0+0x18>

		pst->pid = p->pid;
80103f84:	8b 42 10             	mov    0x10(%edx),%eax
80103f87:	89 43 14             	mov    %eax,0x14(%ebx)

		pst->ppid = p->parent->pid;
80103f8a:	8b 42 14             	mov    0x14(%edx),%eax
80103f8d:	8b 40 10             	mov    0x10(%eax),%eax
80103f90:	89 43 18             	mov    %eax,0x18(%ebx)

		//switch
		if(p->state == EMBRYO){
80103f93:	8b 42 0c             	mov    0xc(%edx),%eax
80103f96:	83 f8 01             	cmp    $0x1,%eax
80103f99:	74 6d                	je     80104008 <procstat0+0xb8>
			pst->state = 'E';
		}
		if(p->state == SLEEPING){
80103f9b:	83 f8 02             	cmp    $0x2,%eax
80103f9e:	74 58                	je     80103ff8 <procstat0+0xa8>
			pst->state = 'S';
		}
		if(p->state == RUNNABLE){
80103fa0:	83 f8 03             	cmp    $0x3,%eax
80103fa3:	74 43                	je     80103fe8 <procstat0+0x98>
			pst->state = 'N';
		}
		if(p->state == RUNNING){
80103fa5:	83 f8 04             	cmp    $0x4,%eax
80103fa8:	74 2e                	je     80103fd8 <procstat0+0x88>
			pst->state = 'R';
		}
		if(p->state == ZOMBIE){
80103faa:	83 f8 05             	cmp    $0x5,%eax
80103fad:	74 21                	je     80103fd0 <procstat0+0x80>
}
...
procstat0(int which, struct pstat*pst){
	int pNum = 0;
80103faf:	31 c0                	xor    %eax,%eax
80103fb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			pst->state = 'Z';
		}

		int i;
		for(i = 0; i<16; ++i){	//copy the name from p character by character into the name array for ps{
	 		pst->name[i] = p->name[i];
80103fb8:	0f b6 4c 02 6c       	movzbl 0x6c(%edx,%eax,1),%ecx
80103fbd:	88 0c 03             	mov    %cl,(%ebx,%eax,1)
		if(p->state == ZOMBIE){
			pst->state = 'Z';
		}
...
80103fc3:	83 f8 10             	cmp    $0x10,%eax
80103fc6:	75 f0                	jne    80103fb8 <procstat0+0x68>
	 		pst->name[i] = p->name[i];
		}
		return 0;
80103fc8:	31 c0                	xor    %eax,%eax
	...
	return 1; //iterated through all processes
}
80103fca:	5b                   	pop    %ebx
80103fcb:	5d                   	pop    %ebp
80103fcc:	c3                   	ret    
80103fcd:	8d 76 00             	lea    0x0(%esi),%esi
		...
		if(p->state == ZOMBIE){
			pst->state = 'Z';
80103fd0:	c6 43 10 5a          	movb   $0x5a,0x10(%ebx)
80103fd4:	eb d9                	jmp    80103faf <procstat0+0x5f>
80103fd6:	66 90                	xchg   %ax,%ax
		...
		if(p->state == RUNNING){
			pst->state = 'R';
80103fd8:	c6 43 10 52          	movb   $0x52,0x10(%ebx)
80103fdc:	8b 42 0c             	mov    0xc(%edx),%eax
80103fdf:	eb c9                	jmp    80103faa <procstat0+0x5a>
80103fe1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		...
		if(p->state == RUNNABLE){
			pst->state = 'N';
80103fe8:	c6 43 10 4e          	movb   $0x4e,0x10(%ebx)
80103fec:	8b 42 0c             	mov    0xc(%edx),%eax
80103fef:	eb b4                	jmp    80103fa5 <procstat0+0x55>
80103ff1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		...
		if(p->state == SLEEPING){
			pst->state = 'S';
80103ff8:	c6 43 10 53          	movb   $0x53,0x10(%ebx)
80103ffc:	8b 42 0c             	mov    0xc(%edx),%eax
80103fff:	eb 9f                	jmp    80103fa0 <procstat0+0x50>
80104001:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		...
		if(p->state == EMBRYO){
			pst->state = 'E';
80104008:	c6 43 10 45          	movb   $0x45,0x10(%ebx)
8010400c:	8b 42 0c             	mov    0xc(%edx),%eax
8010400f:	eb 8a                	jmp    80103f9b <procstat0+0x4b>
	 		pst->name[i] = p->name[i];
		}
		return 0;
...
80104071:	e8 aa 01 00 00       	call   80104220 <acquire>
	while (lk->locked) {
...
80104087:	e8 84 fb ff ff       	call   80103c10 <sleep>
...
80104092:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
	lk->pid    = myproc()->pid;
80104098:	e8 13 f6 ff ff       	call   801036b0 <myproc>
...
801040ab:	5d                   	pop    %ebp
	...
	lk->pid    = myproc()->pid;
	release(&lk->lk);
801040ac:	e9 5f 02 00 00       	jmp    80104310 <release>
...
801040d1:	e8 4a 01 00 00       	call   80104220 <acquire>
	lk->locked = 0;
...
801040e6:	e8 b5 fc ff ff       	call   80103da0 <wakeup>
	release(&lk->lk);
...
801040f3:	5d                   	pop    %ebp
{
	...
	wakeup(lk);
	release(&lk->lk);
801040f4:	e9 17 02 00 00       	jmp    80104310 <release>
...
80104111:	e8 0a 01 00 00       	call   80104220 <acquire>
	r = lk->locked;
80104116:	8b 1b                	mov    (%ebx),%ebx
	release(&lk->lk);
80104118:	89 34 24             	mov    %esi,(%esp)
8010411b:	e8 f0 01 00 00       	call   80104310 <release>
	return r;
}
...
801041b9:	8b 55 08             	mov    0x8(%ebp),%edx
	return lock->locked && lock->cpu == mycpu();
801041bc:	8b 0a                	mov    (%edx),%ecx
801041be:	85 c9                	test   %ecx,%ecx
801041c0:	74 10                	je     801041d2 <holding+0x22>
801041c2:	8b 5a 08             	mov    0x8(%edx),%ebx
801041c5:	e8 46 f4 ff ff       	call   80103610 <mycpu>
801041ca:	39 c3                	cmp    %eax,%ebx
801041cc:	0f 94 c0             	sete   %al
801041cf:	0f b6 c0             	movzbl %al,%eax
}
...
801041ea:	e8 21 f4 ff ff       	call   80103610 <mycpu>
801041ef:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801041f5:	85 c0                	test   %eax,%eax
801041f7:	75 11                	jne    8010420a <pushcli+0x2a>
801041f9:	e8 12 f4 ff ff       	call   80103610 <mycpu>
801041fe:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104204:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
	mycpu()->ncli += 1;
8010420a:	e8 01 f4 ff ff       	call   80103610 <mycpu>
8010420f:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104227:	e8 b4 ff ff ff       	call   801041e0 <pushcli>
...
{
	return lock->locked && lock->cpu == mycpu();
8010422f:	8b 02                	mov    (%edx),%eax
80104231:	85 c0                	test   %eax,%eax
80104233:	75 43                	jne    80104278 <acquire+0x58>
xchg(volatile uint *addr, uint newval)
{
	uint result;
	...
	// The + in "+m" denotes a read-modify-write operand.
	asm volatile("lock; xchgl %0, %1" : "+m"(*addr), "=a"(result) : "1"(newval) : "cc");
80104235:	b9 01 00 00 00       	mov    $0x1,%ecx
8010423a:	eb 07                	jmp    80104243 <acquire+0x23>
8010423c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104240:	8b 55 08             	mov    0x8(%ebp),%edx
80104243:	89 c8                	mov    %ecx,%eax
80104245:	f0 87 02             	lock xchg %eax,(%edx)
{
	pushcli(); // disable interrupts to avoid deadlock.
	if (holding(lk)) panic("acquire");
...
8010424a:	75 f4                	jne    80104240 <acquire+0x20>
		;
	...
	__sync_synchronize();
8010424c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)

	// Record info about lock acquisition for debugging.
	lk->cpu = mycpu();
80104251:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104254:	e8 b7 f3 ff ff       	call   80103610 <mycpu>
80104259:	89 43 08             	mov    %eax,0x8(%ebx)
	getcallerpcs(&lk, lk->pcs);
8010425c:	8b 45 08             	mov    0x8(%ebp),%eax
8010425f:	83 c0 0c             	add    $0xc,%eax
80104262:	89 44 24 04          	mov    %eax,0x4(%esp)
80104266:	8d 45 08             	lea    0x8(%ebp),%eax
80104269:	89 04 24             	mov    %eax,(%esp)
8010426c:	e8 df fe ff ff       	call   80104150 <getcallerpcs>
}
80104271:	83 c4 14             	add    $0x14,%esp
80104274:	5b                   	pop    %ebx
80104275:	5d                   	pop    %ebp
80104276:	c3                   	ret    
80104277:	90                   	nop
...
{
	return lock->locked && lock->cpu == mycpu();
80104278:	8b 5a 08             	mov    0x8(%edx),%ebx
8010427b:	e8 90 f3 ff ff       	call   80103610 <mycpu>
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
...
80104282:	74 05                	je     80104289 <acquire+0x69>
80104284:	8b 55 08             	mov    0x8(%ebp),%edx
80104287:	eb ac                	jmp    80104235 <acquire+0x15>
80104289:	c7 04 24 83 73 10 80 	movl   $0x80107383,(%esp)
80104290:	e8 cb c0 ff ff       	call   80100360 <panic>
...
801042ad:	e8 5e f3 ff ff       	call   80103610 <mycpu>
...
801042c5:	e8 46 f3 ff ff       	call   80103610 <mycpu>
...
popcli(void)
{
	if (readeflags() & FL_IF) panic("popcli - interruptible");
	if (--mycpu()->ncli < 0) panic("popcli");
801042ea:	c7 04 24 a2 73 10 80 	movl   $0x801073a2,(%esp)
...
{
	if (readeflags() & FL_IF) panic("popcli - interruptible");
801042f6:	c7 04 24 8b 73 10 80 	movl   $0x8010738b,(%esp)
...
80104318:	8b 5d 08             	mov    0x8(%ebp),%ebx
...
{
	return lock->locked && lock->cpu == mycpu();
8010431b:	8b 03                	mov    (%ebx),%eax
8010431d:	85 c0                	test   %eax,%eax
8010431f:	75 0f                	jne    80104330 <release+0x20>
...
80104321:	c7 04 24 a9 73 10 80 	movl   $0x801073a9,(%esp)
80104328:	e8 33 c0 ff ff       	call   80100360 <panic>
...
80104333:	e8 d8 f2 ff ff       	call   80103610 <mycpu>
...
8010433a:	75 e5                	jne    80104321 <release+0x11>

	lk->pcs[0] = 0;
8010433c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	lk->cpu    = 0;
80104343:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
	// Tell the C compiler and the processor to not move loads or stores
	...
	__sync_synchronize();
8010434a:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
...
8010435a:	5d                   	pop    %ebp
	...
	popcli();
8010435b:	e9 40 ff ff ff       	jmp    801042a0 <popcli>
...
801045b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
	struct proc *curproc = myproc();
801045ba:	e8 f1 f0 ff ff       	call   801036b0 <myproc>
...
8010465b:	e8 50 f0 ff ff       	call   801036b0 <myproc>
...
80104688:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int          i;
	struct proc *curproc = myproc();
8010468b:	e8 20 f0 ff ff       	call   801036b0 <myproc>
...
80104725:	83 ec 10             	sub    $0x10,%esp
	int          num;
	struct proc *curproc = myproc();
80104728:	e8 83 ef ff ff       	call   801036b0 <myproc>
...
8010473d:	8b 14 85 e0 73 10 80 	mov    -0x7fef8c20(,%eax,4),%edx
...
80104766:	c7 04 24 b1 73 10 80 	movl   $0x801073b1,(%esp)
...
80104796:	83 ec 04             	sub    $0x4,%esp
	int          fd;
	struct proc *curproc = myproc();
80104799:	e8 12 ef ff ff       	call   801036b0 <myproc>
...
801047ec:	89 4d bc             	mov    %ecx,-0x44(%ebp)
	...
	if ((dp = nameiparent(path, name)) == 0) return 0;
801047ef:	e8 3c d7 ff ff       	call   80101f30 <nameiparent>
...
80104801:	e8 ba ce ff ff       	call   801016c0 <ilock>
...
8010484b:	e8 d0 d0 ff ff       	call   80101920 <iunlockput>
	if (dirlink(dp, name, ip->inum) < 0) panic("create: dirlink");
...
8010487f:	e8 3c ce ff ff       	call   801016c0 <ilock>
	ip->major = major;
80104884:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104888:	66 89 46 52          	mov    %ax,0x52(%esi)
	ip->minor = minor;
8010488c:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
...
801048a0:	e8 5b cd ff ff       	call   80101600 <iupdate>

	if (type == T_DIR) { // Create . and .. entries.
801048a5:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
...
801048c6:	e8 55 d0 ff ff       	call   80101920 <iunlockput>

	return ip;
}
801048cb:	83 c4 4c             	add    $0x4c,%esp
...
80104923:	c7 04 24 4b 74 10 80 	movl   $0x8010744b,(%esp)
8010492a:	e8 31 ba ff ff       	call   80100360 <panic>
	}

	if (dirlink(dp, name, ip->inum) < 0) panic("create: dirlink");
8010492f:	c7 04 24 5a 74 10 80 	movl   $0x8010745a,(%esp)
80104936:	e8 25 ba ff ff       	call   80100360 <panic>
	...
	if ((ip = ialloc(dp->dev, type)) == 0) panic("create: ialloc");
8010493b:	c7 04 24 3c 74 10 80 	movl   $0x8010743c,(%esp)
...
80104979:	e8 32 ed ff ff       	call   801036b0 <myproc>
...
80104af3:	78 23                	js     80104b18 <sys_close+0x38>
	myproc()->ofile[fd] = 0;
80104af5:	e8 b6 eb ff ff       	call   801036b0 <myproc>
...
80104ba9:	0f 88 cb 00 00 00    	js     80104c7a <sys_link+0x10a>
	...
	begin_op();
80104baf:	e8 6c df ff ff       	call   80102b20 <begin_op>
	if ((ip = namei(old)) == 0) {
80104bb4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104bb7:	89 04 24             	mov    %eax,(%esp)
80104bba:	e8 51 d3 ff ff       	call   80101f10 <namei>
...
80104be7:	e8 14 ca ff ff       	call   80101600 <iupdate>
	iunlock(ip);
80104bec:	89 1c 24             	mov    %ebx,(%esp)
80104bef:	e8 ac cb ff ff       	call   801017a0 <iunlock>

	if ((dp = nameiparent(new, name)) == 0) goto bad;
80104bf4:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104bf7:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104bfb:	89 04 24             	mov    %eax,(%esp)
80104bfe:	e8 2d d3 ff ff       	call   80101f30 <nameiparent>
...
80104c25:	e8 06 d2 ff ff       	call   80101e30 <dirlink>
...
80104c31:	e8 ea cc ff ff       	call   80101920 <iunlockput>
	iput(ip);
80104c36:	89 1c 24             	mov    %ebx,(%esp)
80104c39:	e8 a2 cb ff ff       	call   801017e0 <iput>

	end_op();
80104c3e:	e8 4d df ff ff       	call   80102b90 <end_op>
	ip->nlink--;
	iupdate(ip);
	iunlockput(ip);
	end_op();
...
80104c53:	e8 c8 cc ff ff       	call   80101920 <iunlockput>
	end_op();
...
80104cae:	0f 88 76 01 00 00    	js     80104e2a <sys_unlink+0x19a>
	...
	begin_op();
80104cb4:	e8 67 de ff ff       	call   80102b20 <begin_op>
...
80104cc6:	e8 65 d2 ff ff       	call   80101f30 <nameiparent>
...
80104cdc:	e8 df c9 ff ff       	call   801016c0 <ilock>

	// Cannot unlink "." or "..".
	if (namecmp(name, ".") == 0 || namecmp(name, "..") == 0) goto bad;
80104ce1:	c7 44 24 04 58 74 10 	movl   $0x80107458,0x4(%esp)
80104ce8:	80 
80104ce9:	89 1c 24             	mov    %ebx,(%esp)
80104cec:	e8 af ce ff ff       	call   80101ba0 <namecmp>
80104cf1:	85 c0                	test   %eax,%eax
80104cf3:	0f 84 21 01 00 00    	je     80104e1a <sys_unlink+0x18a>
80104cf9:	c7 44 24 04 57 74 10 	movl   $0x80107457,0x4(%esp)
80104d00:	80 
80104d01:	89 1c 24             	mov    %ebx,(%esp)
80104d04:	e8 97 ce ff ff       	call   80101ba0 <namecmp>
...
80104d1f:	e8 ac ce ff ff       	call   80101bd0 <dirlookup>
...
80104d31:	e8 8a c9 ff ff       	call   801016c0 <ilock>
...
80104d7c:	e8 ef cc ff ff       	call   80101a70 <writei>
...
80104d9b:	e8 80 cb ff ff       	call   80101920 <iunlockput>
...
80104e01:	e8 6a cb ff ff       	call   80101970 <readi>
...
80104e15:	e8 06 cb ff ff       	call   80101920 <iunlockput>
	end_op();
...
80104e20:	e8 fb ca ff ff       	call   80101920 <iunlockput>
	end_op();
80104e25:	e8 66 dd ff ff       	call   80102b90 <end_op>
	return -1;
}
...
80104e43:	e8 b8 c7 ff ff       	call   80101600 <iupdate>
80104e48:	e9 48 ff ff ff       	jmp    80104d95 <sys_unlink+0x105>
{
	...
	for (off = 2 * sizeof(de); off < dp->size; off += sizeof(de)) {
		if (readi(dp, (char *)&de, off, sizeof(de)) != sizeof(de)) panic("isdirempty: readi");
80104e4d:	c7 04 24 7c 74 10 80 	movl   $0x8010747c,(%esp)
80104e54:	e8 07 b5 ff ff       	call   80100360 <panic>
	...
	memset(&de, 0, sizeof(de));
	if (writei(dp, (char *)&de, off, sizeof(de)) != sizeof(de)) panic("unlink: writei");
80104e59:	c7 04 24 8e 74 10 80 	movl   $0x8010748e,(%esp)
80104e60:	e8 fb b4 ff ff       	call   80100360 <panic>
	...
	if (ip->nlink < 1) panic("unlink: nlink < 1");
80104e65:	c7 04 24 6a 74 10 80 	movl   $0x8010746a,(%esp)
...
80104eb9:	0f 88 b6 00 00 00    	js     80104f75 <sys_open+0xf5>
	...
	begin_op();
80104ebf:	e8 5c dc ff ff       	call   80102b20 <begin_op>
...
80104ed4:	e8 37 d0 ff ff       	call   80101f10 <namei>
...
80104ee6:	e8 d5 c7 ff ff       	call   801016c0 <ilock>
...
80104f17:	e8 84 c8 ff ff       	call   801017a0 <iunlock>
	end_op();
80104f1c:	e8 6f dc ff ff       	call   80102b90 <end_op>
...
80104fc3:	83 ec 28             	sub    $0x28,%esp
	...
	begin_op();
80104fc6:	e8 55 db ff ff       	call   80102b20 <begin_op>
...
80104fff:	e8 1c c9 ff ff       	call   80101920 <iunlockput>
	end_op();
80105004:	e8 87 db ff ff       	call   80102b90 <end_op>
	return 0;
...
8010500d:	8d 76 00             	lea    0x0(%esi),%esi
	...
	if (argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0) {
		end_op();
80105010:	e8 7b db ff ff       	call   80102b90 <end_op>
		return -1;
...
801050b5:	83 ec 20             	sub    $0x20,%esp
	...
	struct inode *ip;
	struct proc * curproc = myproc();
801050b8:	e8 f3 e5 ff ff       	call   801036b0 <myproc>
801050bd:	89 c6                	mov    %eax,%esi

	begin_op();
801050bf:	e8 5c da ff ff       	call   80102b20 <begin_op>
...
801050e1:	e8 2a ce ff ff       	call   80101f10 <namei>
...
801050ef:	e8 cc c5 ff ff       	call   801016c0 <ilock>
	if (ip->type != T_DIR) {
...
801050fc:	75 22                	jne    80105120 <sys_chdir+0x70>
	...
	iunlock(ip);
801050fe:	e8 9d c6 ff ff       	call   801017a0 <iunlock>
	iput(curproc->cwd);
80105103:	8b 46 68             	mov    0x68(%esi),%eax
80105106:	89 04 24             	mov    %eax,(%esp)
80105109:	e8 d2 c6 ff ff       	call   801017e0 <iput>
	end_op();
8010510e:	e8 7d da ff ff       	call   80102b90 <end_op>
	curproc->cwd = ip;
	return 0;
...
8010511f:	90                   	nop
	...
	if (ip->type != T_DIR) {
		iunlockput(ip);
80105120:	e8 fb c7 ff ff       	call   80101920 <iunlockput>
		end_op();
80105125:	e8 66 da ff ff       	call   80102b90 <end_op>
	iunlock(ip);
	iput(curproc->cwd);
	end_op();
	curproc->cwd = ip;
...
80105263:	e8 18 df ff ff       	call   80103180 <pipealloc>
...
80105299:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	...
	if ((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0) {
		if (fd0 >= 0) myproc()->ofile[fd0] = 0;
801052a0:	e8 0b e4 ff ff       	call   801036b0 <myproc>
...
801052d3:	83 ec 28             	sub    $0x28,%esp
	struct pstat *pst;
	int which;
	if (argint(0, &which) < 0 || argptr(1, (void *)&pst, sizeof(*pst)) < 0){
801052d6:	8d 45 f4             	lea    -0xc(%ebp),%eax
801052d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801052dd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052e4:	e8 67 f3 ff ff       	call   80104650 <argint>
801052e9:	85 c0                	test   %eax,%eax
801052eb:	78 33                	js     80105320 <sys_procstat+0x50>
801052ed:	8d 45 f0             	lea    -0x10(%ebp),%eax
801052f0:	c7 44 24 08 1c 00 00 	movl   $0x1c,0x8(%esp)
801052f7:	00 
801052f8:	89 44 24 04          	mov    %eax,0x4(%esp)
801052fc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105303:	e8 78 f3 ff ff       	call   80104680 <argptr>
80105308:	85 c0                	test   %eax,%eax
8010530a:	78 14                	js     80105320 <sys_procstat+0x50>
		return -1;
	}
	return procstat0(which, pst);
...
80105319:	e8 32 ec ff ff       	call   80103f50 <procstat0>
}
8010531e:	c9                   	leave  
8010531f:	c3                   	ret    
//edit
...
80105343:	83 ec 08             	sub    $0x8,%esp
	exit();
80105346:	e8 65 e7 ff ff       	call   80103ab0 <exit>
...
{
	return wait();
80105354:	e9 67 e9 ff ff       	jmp    80103cc0 <wait>
...
80105374:	e8 d7 f2 ff ff       	call   80104650 <argint>
...
80105383:	e8 78 ea ff ff       	call   80103e00 <kill>
}
80105388:	c9                   	leave  
80105389:	c3                   	ret    
...
801053c5:	e8 86 f2 ff ff       	call   80104650 <argint>
...
80105415:	e8 36 f2 ff ff       	call   80104650 <argint>
8010541a:	85 c0                	test   %eax,%eax
8010541c:	78 7e                	js     8010549c <sys_sleep+0x9c>
	acquire(&tickslock);
8010541e:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105425:	e8 f6 ed ff ff       	call   80104220 <acquire>
	ticks0 = ticks;
...
8010542a:	8b 55 f4             	mov    -0xc(%ebp),%edx
	...
	acquire(&tickslock);
	ticks0 = ticks;
8010542d:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
	while (ticks - ticks0 < n) {
...
80105440:	c7 44 24 04 60 4c 11 	movl   $0x80114c60,0x4(%esp)
80105447:	80 
80105448:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
8010544f:	e8 bc e7 ff ff       	call   80103c10 <sleep>
	uint ticks0;
	...
	ticks0 = ticks;
	while (ticks - ticks0 < n) {
80105454:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
8010546a:	74 d4                	je     80105440 <sys_sleep+0x40>
			release(&tickslock);
8010546c:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105473:	e8 98 ee ff ff       	call   80104310 <release>
			return -1;
...
80105484:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	release(&tickslock);
80105488:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
8010548f:	e8 7c ee ff ff       	call   80104310 <release>
	return 0;
}
...
801054ea:	8e c0                	mov    %eax,%es
  ...
  pushl %esp
801054ec:	54                   	push   %esp
  call trap
801054ed:	e8 de 00 00 00       	call   801055d0 <trap>
  addl $4, %esp
801054f2:	83 c4 04             	add    $0x4,%esp
...
801054f5:	61                   	popa   
  popl %gs
801054f6:	0f a9                	pop    %gs
  popl %fs
801054f8:	0f a1                	pop    %fs
  popl %es
801054fa:	07                   	pop    %es
  popl %ds
801054fb:	1f                   	pop    %ds
...
80105514:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
8010551b:	80 
8010551c:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
80105523:	00 
80105524:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010552b:	8e 
8010552c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105533:	80 
80105534:	c1 ea 10             	shr    $0x10,%edx
80105537:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010553e:	80 
...
80105559:	c7 44 24 04 9d 74 10 	movl   $0x8010749d,0x4(%esp)
80105560:	80 
80105561:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
tvinit(void)
{
	int i;
	...
	for (i = 0; i < 256; i++) SETGATE(idt[i], 0, SEG_KCODE << 3, vectors[i], 0);
	SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80105568:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
...
80105586:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
	...
	initlock(&tickslock, "time");
8010558c:	e8 9f eb ff ff       	call   80104130 <initlock>
}
80105591:	c9                   	leave  
80105592:	c3                   	ret    
...
801055ab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
	pd[1] = (uint)p;
801055af:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801055f0:	ff 24 85 44 75 10 80 	jmp    *-0x7fef8abc(,%eax,4)
801055f7:	90                   	nop
		lapiceoi();
		break;
...
801055f8:	e8 b3 e0 ff ff       	call   801036b0 <myproc>
...
8010561c:	e8 6f e0 ff ff       	call   80103690 <cpuid>
...
8010562c:	e8 7f e0 ff ff       	call   801036b0 <myproc>
...
80105663:	c7 04 24 00 75 10 80 	movl   $0x80107500,(%esp)
8010566a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010566e:	e8 dd af ff ff       	call   80100650 <cprintf>
		        "eip 0x%x addr 0x%x--kill proc\n",
		        myproc()->pid, myproc()->name, tf->trapno, tf->err, cpuid(), tf->eip, rcr2());
		myproc()->killed = 1;
80105673:	e8 38 e0 ff ff       	call   801036b0 <myproc>
...
80105689:	e8 22 e0 ff ff       	call   801036b0 <myproc>
...
80105695:	e8 16 e0 ff ff       	call   801036b0 <myproc>
...
801056a9:	74 4d                	je     801056f8 <trap+0x128>
	...
	if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER) exit();
801056ab:	e8 00 e0 ff ff       	call   801036b0 <myproc>
801056b0:	85 c0                	test   %eax,%eax
801056b2:	74 1d                	je     801056d1 <trap+0x101>
801056b4:	e8 f7 df ff ff       	call   801036b0 <myproc>
...
80105702:	e8 c9 e4 ff ff       	call   80103bd0 <yield>
...
8010575c:	c7 04 24 a8 74 10 80 	movl   $0x801074a8,(%esp)
...
801057a1:	89 58 18             	mov    %ebx,0x18(%eax)
		syscall();
801057a4:	e8 77 ef ff ff       	call   80104720 <syscall>
		if (myproc()->killed) exit();
...
801057cf:	90                   	nop
	...
	case T_IRQ0 + IRQ_TIMER:
		if (cpuid() == 0) {
			acquire(&tickslock);
801057d0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801057d7:	e8 44 ea ff ff       	call   80104220 <acquire>
			ticks++;
			wakeup(&ticks);
801057dc:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
	...
	case T_IRQ0 + IRQ_TIMER:
		if (cpuid() == 0) {
			acquire(&tickslock);
			ticks++;
801057e3:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
			wakeup(&ticks);
801057ea:	e8 b1 e5 ff ff       	call   80103da0 <wakeup>
			release(&tickslock);
801057ef:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801057f6:	e8 15 eb ff ff       	call   80104310 <release>
...
80105806:	e8 85 de ff ff       	call   80103690 <cpuid>
...
8010581a:	c7 04 24 cc 74 10 80 	movl   $0x801074cc,(%esp)
80105821:	89 44 24 04          	mov    %eax,0x4(%esp)
80105825:	e8 26 ae ff ff       	call   80100650 <cprintf>
			        rcr2());
			panic("trap");
8010582a:	c7 04 24 a2 74 10 80 	movl   $0x801074a2,(%esp)
...
80105897:	e8 14 cf ff ff       	call   801027b0 <microdelay>
...
80105927:	00 
	...
	for (p = "xv6...\n"; *p; p++) uartputc(*p);
80105928:	bb c4 75 10 80       	mov    $0x801075c4,%ebx
...
80105934:	e8 87 c9 ff ff       	call   801022c0 <ioapicenable>
...
80105976:	6a 00                	push   $0x0
  jmp alltraps
80105978:	e9 60 fb ff ff       	jmp    801054dd <alltraps>
...
8010597f:	6a 01                	push   $0x1
  jmp alltraps
80105981:	e9 57 fb ff ff       	jmp    801054dd <alltraps>
...
80105988:	6a 02                	push   $0x2
  jmp alltraps
8010598a:	e9 4e fb ff ff       	jmp    801054dd <alltraps>
...
80105991:	6a 03                	push   $0x3
  jmp alltraps
80105993:	e9 45 fb ff ff       	jmp    801054dd <alltraps>
...
8010599a:	6a 04                	push   $0x4
  jmp alltraps
8010599c:	e9 3c fb ff ff       	jmp    801054dd <alltraps>
...
801059a3:	6a 05                	push   $0x5
  jmp alltraps
801059a5:	e9 33 fb ff ff       	jmp    801054dd <alltraps>
...
801059ac:	6a 06                	push   $0x6
  jmp alltraps
801059ae:	e9 2a fb ff ff       	jmp    801054dd <alltraps>
...
801059b5:	6a 07                	push   $0x7
  jmp alltraps
801059b7:	e9 21 fb ff ff       	jmp    801054dd <alltraps>
...
801059bc:	6a 08                	push   $0x8
  jmp alltraps
801059be:	e9 1a fb ff ff       	jmp    801054dd <alltraps>
...
801059c5:	6a 09                	push   $0x9
  jmp alltraps
801059c7:	e9 11 fb ff ff       	jmp    801054dd <alltraps>
...
801059cc:	6a 0a                	push   $0xa
  jmp alltraps
801059ce:	e9 0a fb ff ff       	jmp    801054dd <alltraps>
...
801059d3:	6a 0b                	push   $0xb
  jmp alltraps
801059d5:	e9 03 fb ff ff       	jmp    801054dd <alltraps>
...
801059e1:	6a 0d                	push   $0xd
  jmp alltraps
801059e3:	e9 f5 fa ff ff       	jmp    801054dd <alltraps>
...
801059e8:	6a 0e                	push   $0xe
  jmp alltraps
801059ea:	e9 ee fa ff ff       	jmp    801054dd <alltraps>
...
801059f1:	6a 0f                	push   $0xf
  jmp alltraps
801059f3:	e9 e5 fa ff ff       	jmp    801054dd <alltraps>
...
801059fa:	6a 10                	push   $0x10
  jmp alltraps
801059fc:	e9 dc fa ff ff       	jmp    801054dd <alltraps>
...
80105a01:	6a 11                	push   $0x11
  jmp alltraps
80105a03:	e9 d5 fa ff ff       	jmp    801054dd <alltraps>
...
80105a0a:	6a 12                	push   $0x12
  jmp alltraps
80105a0c:	e9 cc fa ff ff       	jmp    801054dd <alltraps>
...
80105a1c:	6a 14                	push   $0x14
  jmp alltraps
80105a1e:	e9 ba fa ff ff       	jmp    801054dd <alltraps>
...
80105a25:	6a 15                	push   $0x15
  jmp alltraps
80105a27:	e9 b1 fa ff ff       	jmp    801054dd <alltraps>
...
80105a2e:	6a 16                	push   $0x16
  jmp alltraps
80105a30:	e9 a8 fa ff ff       	jmp    801054dd <alltraps>
...
80105a37:	6a 17                	push   $0x17
  jmp alltraps
80105a39:	e9 9f fa ff ff       	jmp    801054dd <alltraps>
...
80105a40:	6a 18                	push   $0x18
  jmp alltraps
80105a42:	e9 96 fa ff ff       	jmp    801054dd <alltraps>
...
80105a49:	6a 19                	push   $0x19
  jmp alltraps
80105a4b:	e9 8d fa ff ff       	jmp    801054dd <alltraps>
...
80105a52:	6a 1a                	push   $0x1a
  jmp alltraps
80105a54:	e9 84 fa ff ff       	jmp    801054dd <alltraps>
...
80105a5b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a5d:	e9 7b fa ff ff       	jmp    801054dd <alltraps>
...
80105a64:	6a 1c                	push   $0x1c
  jmp alltraps
80105a66:	e9 72 fa ff ff       	jmp    801054dd <alltraps>
...
80105a6d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a6f:	e9 69 fa ff ff       	jmp    801054dd <alltraps>
...
80105a76:	6a 1e                	push   $0x1e
  jmp alltraps
80105a78:	e9 60 fa ff ff       	jmp    801054dd <alltraps>
...
80105a7f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a81:	e9 57 fa ff ff       	jmp    801054dd <alltraps>
...
80105a88:	6a 20                	push   $0x20
  jmp alltraps
80105a8a:	e9 4e fa ff ff       	jmp    801054dd <alltraps>
...
80105a91:	6a 21                	push   $0x21
  jmp alltraps
80105a93:	e9 45 fa ff ff       	jmp    801054dd <alltraps>
...
80105a9a:	6a 22                	push   $0x22
  jmp alltraps
80105a9c:	e9 3c fa ff ff       	jmp    801054dd <alltraps>
...
80105aa3:	6a 23                	push   $0x23
  jmp alltraps
80105aa5:	e9 33 fa ff ff       	jmp    801054dd <alltraps>
...
80105aac:	6a 24                	push   $0x24
  jmp alltraps
80105aae:	e9 2a fa ff ff       	jmp    801054dd <alltraps>
...
80105ab5:	6a 25                	push   $0x25
  jmp alltraps
80105ab7:	e9 21 fa ff ff       	jmp    801054dd <alltraps>
...
80105abe:	6a 26                	push   $0x26
  jmp alltraps
80105ac0:	e9 18 fa ff ff       	jmp    801054dd <alltraps>
...
80105ac7:	6a 27                	push   $0x27
  jmp alltraps
80105ac9:	e9 0f fa ff ff       	jmp    801054dd <alltraps>
...
80105ad0:	6a 28                	push   $0x28
  jmp alltraps
80105ad2:	e9 06 fa ff ff       	jmp    801054dd <alltraps>
...
80105ad9:	6a 29                	push   $0x29
  jmp alltraps
80105adb:	e9 fd f9 ff ff       	jmp    801054dd <alltraps>
...
80105ae2:	6a 2a                	push   $0x2a
  jmp alltraps
80105ae4:	e9 f4 f9 ff ff       	jmp    801054dd <alltraps>
...
80105aeb:	6a 2b                	push   $0x2b
  jmp alltraps
80105aed:	e9 eb f9 ff ff       	jmp    801054dd <alltraps>
...
80105af4:	6a 2c                	push   $0x2c
  jmp alltraps
80105af6:	e9 e2 f9 ff ff       	jmp    801054dd <alltraps>
...
80105afd:	6a 2d                	push   $0x2d
  jmp alltraps
80105aff:	e9 d9 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b06:	6a 2e                	push   $0x2e
  jmp alltraps
80105b08:	e9 d0 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b0f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b11:	e9 c7 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b18:	6a 30                	push   $0x30
  jmp alltraps
80105b1a:	e9 be f9 ff ff       	jmp    801054dd <alltraps>
...
80105b21:	6a 31                	push   $0x31
  jmp alltraps
80105b23:	e9 b5 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b2a:	6a 32                	push   $0x32
  jmp alltraps
80105b2c:	e9 ac f9 ff ff       	jmp    801054dd <alltraps>
...
80105b33:	6a 33                	push   $0x33
  jmp alltraps
80105b35:	e9 a3 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b3c:	6a 34                	push   $0x34
  jmp alltraps
80105b3e:	e9 9a f9 ff ff       	jmp    801054dd <alltraps>
...
80105b45:	6a 35                	push   $0x35
  jmp alltraps
80105b47:	e9 91 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b4e:	6a 36                	push   $0x36
  jmp alltraps
80105b50:	e9 88 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b57:	6a 37                	push   $0x37
  jmp alltraps
80105b59:	e9 7f f9 ff ff       	jmp    801054dd <alltraps>
...
80105b60:	6a 38                	push   $0x38
  jmp alltraps
80105b62:	e9 76 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b69:	6a 39                	push   $0x39
  jmp alltraps
80105b6b:	e9 6d f9 ff ff       	jmp    801054dd <alltraps>
...
80105b72:	6a 3a                	push   $0x3a
  jmp alltraps
80105b74:	e9 64 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b7b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b7d:	e9 5b f9 ff ff       	jmp    801054dd <alltraps>
...
80105b84:	6a 3c                	push   $0x3c
  jmp alltraps
80105b86:	e9 52 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b8d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b8f:	e9 49 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b96:	6a 3e                	push   $0x3e
  jmp alltraps
80105b98:	e9 40 f9 ff ff       	jmp    801054dd <alltraps>
...
80105b9f:	6a 3f                	push   $0x3f
  jmp alltraps
80105ba1:	e9 37 f9 ff ff       	jmp    801054dd <alltraps>
...
80105ba8:	6a 40                	push   $0x40
  jmp alltraps
80105baa:	e9 2e f9 ff ff       	jmp    801054dd <alltraps>
...
80105bb1:	6a 41                	push   $0x41
  jmp alltraps
80105bb3:	e9 25 f9 ff ff       	jmp    801054dd <alltraps>
...
80105bba:	6a 42                	push   $0x42
  jmp alltraps
80105bbc:	e9 1c f9 ff ff       	jmp    801054dd <alltraps>
...
80105bc3:	6a 43                	push   $0x43
  jmp alltraps
80105bc5:	e9 13 f9 ff ff       	jmp    801054dd <alltraps>
...
80105bcc:	6a 44                	push   $0x44
  jmp alltraps
80105bce:	e9 0a f9 ff ff       	jmp    801054dd <alltraps>
...
80105bd5:	6a 45                	push   $0x45
  jmp alltraps
80105bd7:	e9 01 f9 ff ff       	jmp    801054dd <alltraps>
...
80105bde:	6a 46                	push   $0x46
  jmp alltraps
80105be0:	e9 f8 f8 ff ff       	jmp    801054dd <alltraps>
...
80105be7:	6a 47                	push   $0x47
  jmp alltraps
80105be9:	e9 ef f8 ff ff       	jmp    801054dd <alltraps>
...
80105bf0:	6a 48                	push   $0x48
  jmp alltraps
80105bf2:	e9 e6 f8 ff ff       	jmp    801054dd <alltraps>
...
80105bf9:	6a 49                	push   $0x49
  jmp alltraps
80105bfb:	e9 dd f8 ff ff       	jmp    801054dd <alltraps>
...
80105c02:	6a 4a                	push   $0x4a
  jmp alltraps
80105c04:	e9 d4 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c0b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c0d:	e9 cb f8 ff ff       	jmp    801054dd <alltraps>
...
80105c14:	6a 4c                	push   $0x4c
  jmp alltraps
80105c16:	e9 c2 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c1d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c1f:	e9 b9 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c26:	6a 4e                	push   $0x4e
  jmp alltraps
80105c28:	e9 b0 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c2f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c31:	e9 a7 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c38:	6a 50                	push   $0x50
  jmp alltraps
80105c3a:	e9 9e f8 ff ff       	jmp    801054dd <alltraps>
...
80105c41:	6a 51                	push   $0x51
  jmp alltraps
80105c43:	e9 95 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c4a:	6a 52                	push   $0x52
  jmp alltraps
80105c4c:	e9 8c f8 ff ff       	jmp    801054dd <alltraps>
...
80105c53:	6a 53                	push   $0x53
  jmp alltraps
80105c55:	e9 83 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c5c:	6a 54                	push   $0x54
  jmp alltraps
80105c5e:	e9 7a f8 ff ff       	jmp    801054dd <alltraps>
...
80105c65:	6a 55                	push   $0x55
  jmp alltraps
80105c67:	e9 71 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c6e:	6a 56                	push   $0x56
  jmp alltraps
80105c70:	e9 68 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c77:	6a 57                	push   $0x57
  jmp alltraps
80105c79:	e9 5f f8 ff ff       	jmp    801054dd <alltraps>
...
80105c80:	6a 58                	push   $0x58
  jmp alltraps
80105c82:	e9 56 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c89:	6a 59                	push   $0x59
  jmp alltraps
80105c8b:	e9 4d f8 ff ff       	jmp    801054dd <alltraps>
...
80105c92:	6a 5a                	push   $0x5a
  jmp alltraps
80105c94:	e9 44 f8 ff ff       	jmp    801054dd <alltraps>
...
80105c9b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c9d:	e9 3b f8 ff ff       	jmp    801054dd <alltraps>
...
80105ca4:	6a 5c                	push   $0x5c
  jmp alltraps
80105ca6:	e9 32 f8 ff ff       	jmp    801054dd <alltraps>
...
80105cad:	6a 5d                	push   $0x5d
  jmp alltraps
80105caf:	e9 29 f8 ff ff       	jmp    801054dd <alltraps>
...
80105cb6:	6a 5e                	push   $0x5e
  jmp alltraps
80105cb8:	e9 20 f8 ff ff       	jmp    801054dd <alltraps>
...
80105cbf:	6a 5f                	push   $0x5f
  jmp alltraps
80105cc1:	e9 17 f8 ff ff       	jmp    801054dd <alltraps>
...
80105cc8:	6a 60                	push   $0x60
  jmp alltraps
80105cca:	e9 0e f8 ff ff       	jmp    801054dd <alltraps>
...
80105cd1:	6a 61                	push   $0x61
  jmp alltraps
80105cd3:	e9 05 f8 ff ff       	jmp    801054dd <alltraps>
...
80105cda:	6a 62                	push   $0x62
  jmp alltraps
80105cdc:	e9 fc f7 ff ff       	jmp    801054dd <alltraps>
...
80105ce3:	6a 63                	push   $0x63
  jmp alltraps
80105ce5:	e9 f3 f7 ff ff       	jmp    801054dd <alltraps>
...
80105cec:	6a 64                	push   $0x64
  jmp alltraps
80105cee:	e9 ea f7 ff ff       	jmp    801054dd <alltraps>
...
80105cf5:	6a 65                	push   $0x65
  jmp alltraps
80105cf7:	e9 e1 f7 ff ff       	jmp    801054dd <alltraps>
...
80105cfe:	6a 66                	push   $0x66
  jmp alltraps
80105d00:	e9 d8 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d07:	6a 67                	push   $0x67
  jmp alltraps
80105d09:	e9 cf f7 ff ff       	jmp    801054dd <alltraps>
...
80105d10:	6a 68                	push   $0x68
  jmp alltraps
80105d12:	e9 c6 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d19:	6a 69                	push   $0x69
  jmp alltraps
80105d1b:	e9 bd f7 ff ff       	jmp    801054dd <alltraps>
...
80105d22:	6a 6a                	push   $0x6a
  jmp alltraps
80105d24:	e9 b4 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d2b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d2d:	e9 ab f7 ff ff       	jmp    801054dd <alltraps>
...
80105d34:	6a 6c                	push   $0x6c
  jmp alltraps
80105d36:	e9 a2 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d3d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d3f:	e9 99 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d46:	6a 6e                	push   $0x6e
  jmp alltraps
80105d48:	e9 90 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d4f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d51:	e9 87 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d58:	6a 70                	push   $0x70
  jmp alltraps
80105d5a:	e9 7e f7 ff ff       	jmp    801054dd <alltraps>
...
80105d61:	6a 71                	push   $0x71
  jmp alltraps
80105d63:	e9 75 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d6a:	6a 72                	push   $0x72
  jmp alltraps
80105d6c:	e9 6c f7 ff ff       	jmp    801054dd <alltraps>
...
80105d73:	6a 73                	push   $0x73
  jmp alltraps
80105d75:	e9 63 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d7c:	6a 74                	push   $0x74
  jmp alltraps
80105d7e:	e9 5a f7 ff ff       	jmp    801054dd <alltraps>
...
80105d85:	6a 75                	push   $0x75
  jmp alltraps
80105d87:	e9 51 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d8e:	6a 76                	push   $0x76
  jmp alltraps
80105d90:	e9 48 f7 ff ff       	jmp    801054dd <alltraps>
...
80105d97:	6a 77                	push   $0x77
  jmp alltraps
80105d99:	e9 3f f7 ff ff       	jmp    801054dd <alltraps>
...
80105da0:	6a 78                	push   $0x78
  jmp alltraps
80105da2:	e9 36 f7 ff ff       	jmp    801054dd <alltraps>
...
80105da9:	6a 79                	push   $0x79
  jmp alltraps
80105dab:	e9 2d f7 ff ff       	jmp    801054dd <alltraps>
...
80105db2:	6a 7a                	push   $0x7a
  jmp alltraps
80105db4:	e9 24 f7 ff ff       	jmp    801054dd <alltraps>
...
80105dbb:	6a 7b                	push   $0x7b
  jmp alltraps
80105dbd:	e9 1b f7 ff ff       	jmp    801054dd <alltraps>
...
80105dc4:	6a 7c                	push   $0x7c
  jmp alltraps
80105dc6:	e9 12 f7 ff ff       	jmp    801054dd <alltraps>
...
80105dcd:	6a 7d                	push   $0x7d
  jmp alltraps
80105dcf:	e9 09 f7 ff ff       	jmp    801054dd <alltraps>
...
80105dd6:	6a 7e                	push   $0x7e
  jmp alltraps
80105dd8:	e9 00 f7 ff ff       	jmp    801054dd <alltraps>
...
80105ddf:	6a 7f                	push   $0x7f
  jmp alltraps
80105de1:	e9 f7 f6 ff ff       	jmp    801054dd <alltraps>
...
80105de8:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ded:	e9 eb f6 ff ff       	jmp    801054dd <alltraps>
...
80105df4:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105df9:	e9 df f6 ff ff       	jmp    801054dd <alltraps>
...
80105e00:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e05:	e9 d3 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e0c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e11:	e9 c7 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e18:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e1d:	e9 bb f6 ff ff       	jmp    801054dd <alltraps>
...
80105e24:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e29:	e9 af f6 ff ff       	jmp    801054dd <alltraps>
...
80105e30:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e35:	e9 a3 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e3c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e41:	e9 97 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e48:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e4d:	e9 8b f6 ff ff       	jmp    801054dd <alltraps>
...
80105e54:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e59:	e9 7f f6 ff ff       	jmp    801054dd <alltraps>
...
80105e60:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e65:	e9 73 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e6c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105e71:	e9 67 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e78:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105e7d:	e9 5b f6 ff ff       	jmp    801054dd <alltraps>
...
80105e84:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105e89:	e9 4f f6 ff ff       	jmp    801054dd <alltraps>
...
80105e90:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105e95:	e9 43 f6 ff ff       	jmp    801054dd <alltraps>
...
80105e9c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ea1:	e9 37 f6 ff ff       	jmp    801054dd <alltraps>
...
80105ea8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105ead:	e9 2b f6 ff ff       	jmp    801054dd <alltraps>
...
80105eb4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105eb9:	e9 1f f6 ff ff       	jmp    801054dd <alltraps>
...
80105ec0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ec5:	e9 13 f6 ff ff       	jmp    801054dd <alltraps>
...
80105ecc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105ed1:	e9 07 f6 ff ff       	jmp    801054dd <alltraps>
...
80105ed8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105edd:	e9 fb f5 ff ff       	jmp    801054dd <alltraps>
...
80105ee4:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105ee9:	e9 ef f5 ff ff       	jmp    801054dd <alltraps>
...
80105ef0:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105ef5:	e9 e3 f5 ff ff       	jmp    801054dd <alltraps>
...
80105efc:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f01:	e9 d7 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f08:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f0d:	e9 cb f5 ff ff       	jmp    801054dd <alltraps>
...
80105f14:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f19:	e9 bf f5 ff ff       	jmp    801054dd <alltraps>
...
80105f20:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f25:	e9 b3 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f2c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f31:	e9 a7 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f38:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f3d:	e9 9b f5 ff ff       	jmp    801054dd <alltraps>
...
80105f44:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f49:	e9 8f f5 ff ff       	jmp    801054dd <alltraps>
...
80105f50:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f55:	e9 83 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f5c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f61:	e9 77 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f68:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f6d:	e9 6b f5 ff ff       	jmp    801054dd <alltraps>
...
80105f74:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105f79:	e9 5f f5 ff ff       	jmp    801054dd <alltraps>
...
80105f80:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105f85:	e9 53 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f8c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105f91:	e9 47 f5 ff ff       	jmp    801054dd <alltraps>
...
80105f98:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105f9d:	e9 3b f5 ff ff       	jmp    801054dd <alltraps>
...
80105fa4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fa9:	e9 2f f5 ff ff       	jmp    801054dd <alltraps>
...
80105fb0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105fb5:	e9 23 f5 ff ff       	jmp    801054dd <alltraps>
...
80105fbc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105fc1:	e9 17 f5 ff ff       	jmp    801054dd <alltraps>
...
80105fc8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105fcd:	e9 0b f5 ff ff       	jmp    801054dd <alltraps>
...
80105fd4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105fd9:	e9 ff f4 ff ff       	jmp    801054dd <alltraps>
...
80105fe0:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105fe5:	e9 f3 f4 ff ff       	jmp    801054dd <alltraps>
...
80105fec:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105ff1:	e9 e7 f4 ff ff       	jmp    801054dd <alltraps>
...
80105ff8:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105ffd:	e9 db f4 ff ff       	jmp    801054dd <alltraps>
...
80106004:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106009:	e9 cf f4 ff ff       	jmp    801054dd <alltraps>
...
80106010:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106015:	e9 c3 f4 ff ff       	jmp    801054dd <alltraps>
...
8010601c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106021:	e9 b7 f4 ff ff       	jmp    801054dd <alltraps>
...
80106028:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010602d:	e9 ab f4 ff ff       	jmp    801054dd <alltraps>
...
80106034:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106039:	e9 9f f4 ff ff       	jmp    801054dd <alltraps>
...
80106040:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106045:	e9 93 f4 ff ff       	jmp    801054dd <alltraps>
...
8010604c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106051:	e9 87 f4 ff ff       	jmp    801054dd <alltraps>
...
80106058:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010605d:	e9 7b f4 ff ff       	jmp    801054dd <alltraps>
...
80106064:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106069:	e9 6f f4 ff ff       	jmp    801054dd <alltraps>
...
80106070:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106075:	e9 63 f4 ff ff       	jmp    801054dd <alltraps>
...
8010607c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106081:	e9 57 f4 ff ff       	jmp    801054dd <alltraps>
...
80106088:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010608d:	e9 4b f4 ff ff       	jmp    801054dd <alltraps>
...
80106094:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106099:	e9 3f f4 ff ff       	jmp    801054dd <alltraps>
...
801060a0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060a5:	e9 33 f4 ff ff       	jmp    801054dd <alltraps>
...
801060ac:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060b1:	e9 27 f4 ff ff       	jmp    801054dd <alltraps>
...
801060b8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060bd:	e9 1b f4 ff ff       	jmp    801054dd <alltraps>
...
801060c4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060c9:	e9 0f f4 ff ff       	jmp    801054dd <alltraps>
...
801060d0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801060d5:	e9 03 f4 ff ff       	jmp    801054dd <alltraps>
...
801060dc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801060e1:	e9 f7 f3 ff ff       	jmp    801054dd <alltraps>
...
801060e8:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801060ed:	e9 eb f3 ff ff       	jmp    801054dd <alltraps>
...
801060f4:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801060f9:	e9 df f3 ff ff       	jmp    801054dd <alltraps>
...
80106100:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106105:	e9 d3 f3 ff ff       	jmp    801054dd <alltraps>
...
8010610c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106111:	e9 c7 f3 ff ff       	jmp    801054dd <alltraps>
...
80106118:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010611d:	e9 bb f3 ff ff       	jmp    801054dd <alltraps>
...
80106124:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106129:	e9 af f3 ff ff       	jmp    801054dd <alltraps>
...
80106130:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106135:	e9 a3 f3 ff ff       	jmp    801054dd <alltraps>
...
8010613c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106141:	e9 97 f3 ff ff       	jmp    801054dd <alltraps>
...
80106148:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010614d:	e9 8b f3 ff ff       	jmp    801054dd <alltraps>
...
80106154:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106159:	e9 7f f3 ff ff       	jmp    801054dd <alltraps>
...
80106160:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106165:	e9 73 f3 ff ff       	jmp    801054dd <alltraps>
...
8010616c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106171:	e9 67 f3 ff ff       	jmp    801054dd <alltraps>
...
80106178:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010617d:	e9 5b f3 ff ff       	jmp    801054dd <alltraps>
...
80106184:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106189:	e9 4f f3 ff ff       	jmp    801054dd <alltraps>
...
80106190:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106195:	e9 43 f3 ff ff       	jmp    801054dd <alltraps>
...
8010619c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061a1:	e9 37 f3 ff ff       	jmp    801054dd <alltraps>
...
801061a8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061ad:	e9 2b f3 ff ff       	jmp    801054dd <alltraps>
...
801061b4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061b9:	e9 1f f3 ff ff       	jmp    801054dd <alltraps>
...
801061c0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061c5:	e9 13 f3 ff ff       	jmp    801054dd <alltraps>
...
801061cc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801061d1:	e9 07 f3 ff ff       	jmp    801054dd <alltraps>
...
801061d8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801061dd:	e9 fb f2 ff ff       	jmp    801054dd <alltraps>
...
801061e4:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801061e9:	e9 ef f2 ff ff       	jmp    801054dd <alltraps>
...
801061f0:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801061f5:	e9 e3 f2 ff ff       	jmp    801054dd <alltraps>
...
801061fc:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106201:	e9 d7 f2 ff ff       	jmp    801054dd <alltraps>
...
80106208:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010620d:	e9 cb f2 ff ff       	jmp    801054dd <alltraps>
...
80106214:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106219:	e9 bf f2 ff ff       	jmp    801054dd <alltraps>
...
80106220:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106225:	e9 b3 f2 ff ff       	jmp    801054dd <alltraps>
...
8010622c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106231:	e9 a7 f2 ff ff       	jmp    801054dd <alltraps>
...
80106238:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010623d:	e9 9b f2 ff ff       	jmp    801054dd <alltraps>
...
80106244:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106249:	e9 8f f2 ff ff       	jmp    801054dd <alltraps>
...
80106250:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106255:	e9 83 f2 ff ff       	jmp    801054dd <alltraps>
...
8010625c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106261:	e9 77 f2 ff ff       	jmp    801054dd <alltraps>
...
80106268:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010626d:	e9 6b f2 ff ff       	jmp    801054dd <alltraps>
...
80106274:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106279:	e9 5f f2 ff ff       	jmp    801054dd <alltraps>
...
80106280:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106285:	e9 53 f2 ff ff       	jmp    801054dd <alltraps>
...
8010628c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106291:	e9 47 f2 ff ff       	jmp    801054dd <alltraps>
...
80106298:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010629d:	e9 3b f2 ff ff       	jmp    801054dd <alltraps>
...
801062a4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062a9:	e9 2f f2 ff ff       	jmp    801054dd <alltraps>
...
801062b0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062b5:	e9 23 f2 ff ff       	jmp    801054dd <alltraps>
...
801062bc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801062c1:	e9 17 f2 ff ff       	jmp    801054dd <alltraps>
...
801062c8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062cd:	e9 0b f2 ff ff       	jmp    801054dd <alltraps>
...
801062d4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801062d9:	e9 ff f1 ff ff       	jmp    801054dd <alltraps>
...
801062e0:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801062e5:	e9 f3 f1 ff ff       	jmp    801054dd <alltraps>
...
801062ec:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801062f1:	e9 e7 f1 ff ff       	jmp    801054dd <alltraps>
...
801062f8:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801062fd:	e9 db f1 ff ff       	jmp    801054dd <alltraps>
...
80106304:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106309:	e9 cf f1 ff ff       	jmp    801054dd <alltraps>
...
80106310:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106315:	e9 c3 f1 ff ff       	jmp    801054dd <alltraps>
...
8010631c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106321:	e9 b7 f1 ff ff       	jmp    801054dd <alltraps>
...
80106328:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010632d:	e9 ab f1 ff ff       	jmp    801054dd <alltraps>
...
80106334:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106339:	e9 9f f1 ff ff       	jmp    801054dd <alltraps>
...
80106340:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106345:	e9 93 f1 ff ff       	jmp    801054dd <alltraps>
...
8010634c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106351:	e9 87 f1 ff ff       	jmp    801054dd <alltraps>
...
80106358:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010635d:	e9 7b f1 ff ff       	jmp    801054dd <alltraps>
...
80106364:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106369:	e9 6f f1 ff ff       	jmp    801054dd <alltraps>
...
80106370:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106375:	e9 63 f1 ff ff       	jmp    801054dd <alltraps>
...
8010637c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106381:	e9 57 f1 ff ff       	jmp    801054dd <alltraps>
...
80106388:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010638d:	e9 4b f1 ff ff       	jmp    801054dd <alltraps>
...
80106394:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106399:	e9 3f f1 ff ff       	jmp    801054dd <alltraps>
...
801063a0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063a5:	e9 33 f1 ff ff       	jmp    801054dd <alltraps>
...
801063ac:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063b1:	e9 27 f1 ff ff       	jmp    801054dd <alltraps>
...
801063b8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063bd:	e9 1b f1 ff ff       	jmp    801054dd <alltraps>
...
801063c4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063c9:	e9 0f f1 ff ff       	jmp    801054dd <alltraps>
...
801063d0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801063d5:	e9 03 f1 ff ff       	jmp    801054dd <alltraps>
...
801063dc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801063e1:	e9 f7 f0 ff ff       	jmp    801054dd <alltraps>
...
80106434:	e8 77 c0 ff ff       	call   801024b0 <kalloc>
...
80106452:	e8 09 df ff ff       	call   80104360 <memset>
		// The permissions here are overly generous, but they can
		// be further restricted by the permissions in the page table
		// entries, if necessary.
		*pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801064f1:	c3                   	ret    
	...
	for (;;) {
		if ((pte = walkpgdir(pgdir, a, 1)) == 0) return -1;
		if (*pte & PTE_P) panic("remap");
801064f2:	c7 04 24 cc 75 10 80 	movl   $0x801075cc,(%esp)
...
80106543:	e8 b8 bd ff ff       	call   80102300 <kfree>
			*pte = 0;
...
801065a3:	83 ec 18             	sub    $0x18,%esp
	...
	c                 = &cpus[cpuid()];
801065a6:	e8 e5 d0 ff ff       	call   80103690 <cpuid>
...
80106660:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
801066a4:	0f 84 c3 00 00 00    	je     8010676d <switchuvm+0xed>
	...
	pushcli();
801066aa:	e8 31 db ff ff       	call   801041e0 <pushcli>
	mycpu()->gdt[SEG_TSS]   = SEG16(STS_T32A, &mycpu()->ts, sizeof(mycpu()->ts) - 1, 0);
801066af:	e8 5c cf ff ff       	call   80103610 <mycpu>
801066b4:	89 c3                	mov    %eax,%ebx
801066b6:	e8 55 cf ff ff       	call   80103610 <mycpu>
801066bb:	89 c7                	mov    %eax,%edi
801066bd:	e8 4e cf ff ff       	call   80103610 <mycpu>
...
80106709:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
	...
	mycpu()->gdt[SEG_TSS]   = SEG16(STS_T32A, &mycpu()->ts, sizeof(mycpu()->ts) - 1, 0);
	mycpu()->gdt[SEG_TSS].s = 0;
8010670e:	e8 fd ce ff ff       	call   80103610 <mycpu>
80106713:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
	mycpu()->ts.ss0         = SEG_KDATA << 3;
8010671a:	e8 f1 ce ff ff       	call   80103610 <mycpu>
8010671f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106724:	66 89 48 10          	mov    %cx,0x10(%eax)
	mycpu()->ts.esp0        = (uint)p->kstack + KSTACKSIZE;
80106728:	e8 e3 ce ff ff       	call   80103610 <mycpu>
...
80106736:	89 48 0c             	mov    %ecx,0xc(%eax)
	...
	// forbids I/O instructions (e.g., inb and outb) from user space
	mycpu()->ts.iomb = (ushort)0xFFFF;
80106739:	e8 d2 ce ff ff       	call   80103610 <mycpu>
...
8010675b:	5d                   	pop    %ebp
	...
	lcr3(V2P(p->pgdir)); // switch to process's address space
	popcli();
8010675c:	e9 3f db ff ff       	jmp    801042a0 <popcli>
...
{
	if (p == 0) panic("switchuvm: no process");
80106761:	c7 04 24 d2 75 10 80 	movl   $0x801075d2,(%esp)
80106768:	e8 f3 9b ff ff       	call   80100360 <panic>
	if (p->kstack == 0) panic("switchuvm: no kstack");
	if (p->pgdir == 0) panic("switchuvm: no pgdir");
8010676d:	c7 04 24 fd 75 10 80 	movl   $0x801075fd,(%esp)
...
switchuvm(struct proc *p)
{
	if (p == 0) panic("switchuvm: no process");
	if (p->kstack == 0) panic("switchuvm: no kstack");
80106779:	c7 04 24 e8 75 10 80 	movl   $0x801075e8,(%esp)
...
801067ab:	77 54                	ja     80106801 <inituvm+0x71>
	mem = kalloc();
801067ad:	e8 fe bc ff ff       	call   801024b0 <kalloc>
	memset(mem, 0, PGSIZE);
...
801067c7:	e8 94 db ff ff       	call   80104360 <memset>
...
801067fb:	5d                   	pop    %ebp
	...
	mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W | PTE_U);
	memmove(mem, init, sz);
801067fc:	e9 ff db ff ff       	jmp    80104400 <memmove>
void
inituvm(pde_t *pgdir, char *init, uint sz)
{
	char *mem;
	...
	if (sz >= PGSIZE) panic("inituvm: more than a page");
80106801:	c7 04 24 11 76 10 80 	movl   $0x80107611,(%esp)
...
8010688d:	e8 de b0 ff ff       	call   80101970 <readi>
...
801068b1:	c3                   	ret    
	...
	for (i = 0; i < sz; i += PGSIZE) {
		if ((pte = walkpgdir(pgdir, addr + i, 0)) == 0) panic("loaduvm: address should exist");
801068b2:	c7 04 24 2b 76 10 80 	movl   $0x8010762b,(%esp)
...
loaduvm(pde_t *pgdir, char *addr, struct inode *ip, uint offset, uint sz)
{
	...
	if ((uint)addr % PGSIZE != 0) panic("loaduvm: addr must be page aligned");
801068be:	c7 04 24 cc 76 10 80 	movl   $0x801076cc,(%esp)
...
80106913:	e8 48 da ff ff       	call   80104360 <memset>
...
80106944:	76 2a                	jbe    80106970 <allocuvm+0xa0>
		mem = kalloc();
80106946:	e8 65 bb ff ff       	call   801024b0 <kalloc>
		if (mem == 0) {
...
8010694f:	75 af                	jne    80106900 <allocuvm+0x30>
			cprintf("allocuvm out of memory\n");
80106951:	c7 04 24 49 76 10 80 	movl   $0x80107649,(%esp)
...
8010697a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		...
		if (mappages(pgdir, (char *)a, PGSIZE, V2P(mem), PTE_W | PTE_U) < 0) {
			cprintf("allocuvm out of memory (2)\n");
80106980:	c7 04 24 61 76 10 80 	movl   $0x80107661,(%esp)
...
freevm(pde_t *pgdir)
{
	...
	if (pgdir == 0) panic("freevm: no pgdir");
80106a48:	c7 04 24 7d 76 10 80 	movl   $0x8010767d,(%esp)
...
80106a8b:	e8 d0 d8 ff ff       	call   80104360 <memset>
	if (P2V(PHYSTOP) > (void *)DEVSPACE) panic("PHYSTOP too high");
	for (k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106afb:	a3 a4 54 11 80       	mov    %eax,0x801154a4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
clearpteu(pde_t *pgdir, char *uva)
{
	...
	pte = walkpgdir(pgdir, uva, 0);
	if (pte == 0) panic("clearpteu");
80106b2c:	c7 04 24 8e 76 10 80 	movl   $0x8010768e,(%esp)
...
80106b53:	0f 84 b2 00 00 00    	je     80106c0b <copyuvm+0xcb>
	for (i = 0; i < sz; i += PGSIZE) {
80106b59:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b5c:	85 c0                	test   %eax,%eax
80106b5e:	0f 84 9c 00 00 00    	je     80106c00 <copyuvm+0xc0>
...
80106b7d:	e8 7e d8 ff ff       	call   80104400 <memmove>
...
80106b8b:	89 14 24             	mov    %edx,(%esp)
80106b8e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b93:	89 da                	mov    %ebx,%edx
...
80106ba3:	78 41                	js     80106be6 <copyuvm+0xa6>
	pte_t *pte;
	uint   pa, i, flags;
	char * mem;
...
80106bab:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106bae:	76 50                	jbe    80106c00 <copyuvm+0xc0>
		if ((pte = walkpgdir(pgdir, (void *)i, 0)) == 0) panic("copyuvm: pte should exist");
80106bb0:	8b 45 08             	mov    0x8(%ebp),%eax
80106bb3:	31 c9                	xor    %ecx,%ecx
80106bb5:	89 da                	mov    %ebx,%edx
80106bb7:	e8 34 f8 ff ff       	call   801063f0 <walkpgdir>
80106bbc:	85 c0                	test   %eax,%eax
80106bbe:	74 5b                	je     80106c1b <copyuvm+0xdb>
		if (!(*pte & PTE_P)) panic("copyuvm: page not present");
80106bc0:	8b 30                	mov    (%eax),%esi
80106bc2:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bc8:	74 45                	je     80106c0f <copyuvm+0xcf>
		pa    = PTE_ADDR(*pte);
80106bca:	89 f7                	mov    %esi,%edi
		flags = PTE_FLAGS(*pte);
80106bcc:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106bd2:	89 75 e4             	mov    %esi,-0x1c(%ebp)
	...
	for (i = 0; i < sz; i += PGSIZE) {
		...
		if (!(*pte & PTE_P)) panic("copyuvm: page not present");
		pa    = PTE_ADDR(*pte);
80106bd5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
		flags = PTE_FLAGS(*pte);
		if ((mem = kalloc()) == 0) goto bad;
80106bdb:	e8 d0 b8 ff ff       	call   801024b0 <kalloc>
80106be0:	85 c0                	test   %eax,%eax
80106be2:	89 c6                	mov    %eax,%esi
80106be4:	75 82                	jne    80106b68 <copyuvm+0x28>
		if (mappages(d, (void *)i, PGSIZE, V2P(mem), flags) < 0) goto bad;
	}
	return d;
...
80106bec:	e8 ef fd ff ff       	call   801069e0 <freevm>
	return 0;
80106bf1:	31 c0                	xor    %eax,%eax
}
80106bf3:	83 c4 2c             	add    $0x2c,%esp
80106bf6:	5b                   	pop    %ebx
80106bf7:	5e                   	pop    %esi
80106bf8:	5f                   	pop    %edi
80106bf9:	5d                   	pop    %ebp
...
80106c03:	83 c4 2c             	add    $0x2c,%esp
80106c06:	5b                   	pop    %ebx
80106c07:	5e                   	pop    %esi
80106c08:	5f                   	pop    %edi
80106c09:	5d                   	pop    %ebp
80106c0a:	c3                   	ret    
	...
	if ((d = setupkvm()) == 0) return 0;
80106c0b:	31 c0                	xor    %eax,%eax
80106c0d:	eb e4                	jmp    80106bf3 <copyuvm+0xb3>
	for (i = 0; i < sz; i += PGSIZE) {
		if ((pte = walkpgdir(pgdir, (void *)i, 0)) == 0) panic("copyuvm: pte should exist");
		if (!(*pte & PTE_P)) panic("copyuvm: page not present");
80106c0f:	c7 04 24 b2 76 10 80 	movl   $0x801076b2,(%esp)
80106c16:	e8 45 97 ff ff       	call   80100360 <panic>
	uint   pa, i, flags;
	char * mem;
	...
	for (i = 0; i < sz; i += PGSIZE) {
		if ((pte = walkpgdir(pgdir, (void *)i, 0)) == 0) panic("copyuvm: pte should exist");
80106c1b:	c7 04 24 98 76 10 80 	movl   $0x80107698,(%esp)
...
80106cac:	e8 4f d7 ff ff       	call   80104400 <memmove>
		len -= n;
		buf += n;
